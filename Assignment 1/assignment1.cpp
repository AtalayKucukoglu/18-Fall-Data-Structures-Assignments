 ...
 * 
 * This program takes two command line arguements as grid-file.txt and instructions-file.txt. 
 * This program creates a grid, creates shapes inside the grid and moves them inside the grid.
 * The commands of grid's size, shapes and movement are read from the text files.
 */
...
/*
 * Prints error message if the placement fails
 * 
 * @param error_type error type ('B' for border and 'C' for conflict)
 * @param op_type operator type
 * @param center_row row of the center of the shape
 * @param center_col column of the center of the shape
 * @param scale scale of the shape
...
/*
 * Prints error message if the movement fails
 * 
 * @param error_type error type ('B' for border and 'C' for conflict)
 * @param op_type operator type
 * @param center_row row of the center of the shape
...
/*
 * Copies the properties of the element to be moved to target element
 * 
 * @param grid grid to be worked on
 * @param target_element one of the elements of the shape
 * @param target_row row of the target element to be moved
 * @param target_col column of the target element to be moved
 * 
 */
void copy_element (Grid_Elements** grid, Grid_Elements &target_element, int target_row, int target_col) {
...
/*
 * Finds the new location of the shape
 * 
 * @param &new_location the address of new_location
 * @param direction the driction of movement
 * @param center_row row of the center of the shape
 * @param center_col column of the center of the shape
 * @param move_by magnitude of movement
 */
void find_new_location ( Location &new_location, char direction, int center_row, int center_col, int move_by) {
